...
describe('Family Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.families?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to familyService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getFamilyIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFamilyIdentifier).toHaveBeenCalledWith(entity);
